...
pub fn load_from(lookup: impl Fn(&str) -> Option<String>) -> McpEnvValues {
    McpEnvValues {
        chapter_publishing_mcp_server_bind: lookup("CHAPTER_PUBLISHING_MCP_SERVER_BIND")
...
pub fn load_env_map(
    ...
    let mut out = std::collections::BTreeMap::new();
    let chapter_publishing_mcp_server_bind = pick(
        &["CHAPTER_PUBLISHING_MCP_SERVER_BIND"],
